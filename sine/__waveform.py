...
it's the waveform that is being played.
...
`sample_rate`: set's the sample rate attribute  (the sample rate is the number of samples played by second)"""
...
For more about the `WaveForm` object,
